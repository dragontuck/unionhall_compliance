...
/****** Object:  Table [dbo].[CMP_HireData3to12to1]    Script Date: 7/3/2025 11:50:07 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[CMP_HireData3to1](
	[EmployerId] [nvarchar](100) NOT NULL,
	[ContractorName] [varchar](255) NOT NULL,
	[MemberName] [varchar](255) NOT NULL,
	[IANumber] [nvarchar](100) NULL,
	[StartDate] [date] NOT NULL,
	[HireType] [nvarchar](50) NOT NULL,
	[IsReviewed] [varchar](10) NULL,
	[IsExcluded] [varchar](255) NULL,
	[EndDate] [date] NULL,
	[ContractorID] [int] NOT NULL,
	[ReviewedDate] [datetimeoffset](7) NOT NULL
) ON [PRIMARY]
GO

CREATE TABLE [dbo].[CMP_StartingPoint3to1](
	[EmployerId] [nvarchar](100) NOT NULL,
	[ContractorID] [int] NOT NULL,
	[ContractorName] [varchar](255) NOT NULL,
	[MemberName] [varchar](255) NOT NULL,
...
ContractorName				
            FROM   (SELECT EmployerId,				
                           ContractorId,				
                           ContractorName				
                    FROM   dbo.CMP_HireData3to1				
                    WHERE  [StartDate] >= '2025-09-15'				
                    UNION				
                    SELECT EmployerId,				
                           ContractorId,				
                           ContractorName				
